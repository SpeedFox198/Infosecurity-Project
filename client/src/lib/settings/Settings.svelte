...
async function enableTwoFA () {
  await fetch("https://127.0.0.1:8443/api/settings/twofa_secretgenerate", {
    method: "POST",
    headers: {
...
async function disableTwoFa () {
  await fetch("https://127.0.0.1:8443/api/settings/twofa-delete", {
    method: "POST",
    headers: {
      "Content-Type": "application/json"
    },
...
<SlidingMenu title="Two Factor Authentication" display={displayTwoFactorEnabling} on:click={toggleTwoFactorEnabling} right={true}>
  <div>
    ...
    <img class="QR2fa" src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=otpauth://totp/Bubbles Authenticator ({ currentUser.username })?secret=JBSWY3DPEHPK3PXP&issuer=Bubbles" alt="QR Code" />
    <form method="POST" action="/twofa" class="form2fa">
